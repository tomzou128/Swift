...
If we bind the accessory type property with the cell and reuse the cell, it will show the previous accessory type propoerty in the new cell. Therefore, we should bind this information with the 
```swift
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        //
